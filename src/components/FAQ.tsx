        ...
        <div className="col-lg-10">
          <div className="faq-shell">
            <div className="faq-header">
              <span className="faq-kicker">Travel support</span>
              <h2 className="faq-title">Frequently Asked Questions</h2>
              <p className="faq-subtitle">
                Helpful answers about flight research, booking planning, and trip details.
              </p>
            </div>
                  ...
                  <div className="accordion-item faq-item" key={item.id}>
                    ...
                    >
                      <div className="accordion-body faq-answer">
                        {item.answer.replace(/{{SITE_NAME}}/g, SITE_NAME)}
                      </div>
                    </div>
                  </div>
                );
