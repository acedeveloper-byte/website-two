    ...
    <section className="container py-5">
      ...
      <div className="card border-0 rounded-4 shadow-sm p-4">
        ...
        <p className="text-muted">
          {SITE_NAME} provides information only. Any cancellations or refunds for bookings are handled by the airline or booking platform used for your reservation.
        </p>
        ...
        <p className="text-muted mb-0">
          If you need more assistance understanding cancellation rules, please contact the airline or our travel support line at <a href={`tel:${PHONE_NUMBER}`} className="text-decoration-none fw-semibold">{PHONE_NUMBER_DISPLAY}</a>.
        </p>
      </div>
    </section>
  );
