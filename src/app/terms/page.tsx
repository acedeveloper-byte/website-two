    ...
    <section className="container py-5">
      <div className="text-center mb-5">
        ...
        <p className="text-muted mx-auto" style={{ maxWidth: 760 }}>
          Review the terms that govern your use of Travelly and the information we provide about travel planning.
        </p>
      </div>
      <div className="card border-0 rounded-4 shadow-sm p-4">
        <h5 className="fw-semibold">1. General Use</h5>
        <p className="text-muted">
          Travelly provides travel planning information and guidance. By using this site, you agree to these terms and any updates we make.
        </p>
